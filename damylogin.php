...
<head>
    ...
    <style>
        ...
        .bg-container {
            background: linear-gradient(rgba(10, 30, 20, 0.6), rgba(0, 0, 0, 0.8)), 
                        url('https://images.unsplash.com/photo-1597338831017-f5478e69816a?auto=format&fit=crop&w=1600&q=80');
        ...
        button {
            ...
            padding: 16px;
            background: #2ecc71;
            color: #051a0e; /* Darker text for better contrast on green */
            border: none;
            border-radius: 16px;
            font-size: 1.1rem;
            font-weight: 800;
...
<body>
    ...
    <div class="bg-container">
        <div class="login-card">
            <div class="logo-area">
                <h1>♻️ E-Waste <span>Connect</span></h1>
